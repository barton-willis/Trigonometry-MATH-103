...
\begin{flushleft}
  \large
\textbf{Forty Five Questions for Dr.\ Willis}
\end{flushleft}  
\normalsize
%\subsubsection*{FAQ}
\begin{enumerate}
...
\item  \textbf{Answer} Unless the question explicity says which form,
you are free to express yourself in whatever way you wish.

\item \textbf{Question} Is this OK, or do I need to simplify it?

\item  \textbf{Answer} Mabye. Giving guidelines on what it means to 
...
students would be much better served if we gave them guidence that was firmly
...
\item  \textbf{Question} What is your favorite comfort food?
  ...
  they visit my garden and gobble up the crop.
...
\textbf{Answer}  Except for the this question, yes.
\end{enumerate}
