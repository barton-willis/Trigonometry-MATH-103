...
y &= r \sin(\theta)
\end{align*}
For $r > 0$ and $0 \leq \theta < 2$
\begin{align*}
r &= \sqrt{x^2 + y^2} \\
\theta &= \begin{cases} \arccos(\nicefrac{x}{r})  & \mbox{ if } y \geq 0 \\
...
%&\big [\cos(a) = b  \big] \equiv \big [a = \pm \cos^{-1}(b) + 2 k \uppi \big ]\\
%&\big [\sin(a) = b  \big] \equiv \big [a = \pm \cos^{-1}(b) + \nicefrac{\uppi}{2}  2 k \uppi \big ]\\
%&\big [\tan(a) = b  \big] \equiv \big [a = \tan^{-1}(b) +  k \uppi \big ]
\end{align*}
\end{minipage}
...
\noindent Revised 19 November 2021. Barton Willis is the author of this work. It 
