...
\usepackage{isomath,upgreek,comment,fourier}
\usepackage{pdfpages}
...
\vfill
%\tiny
\noindent For a comprehensive list of trigonometric function facts, see \url{https://dlmf.nist.gov/4.14}.
...
\begin{tabular}{|l|l|l|l|l|}
  \hline
  \textbf{Function} & \textbf{Domain} & \textbf{ Range } & \textbf{Zeros} & \textbf{Graph} \\ \hline \hline
  $\cos$           & $\reals$       & $[-1,1] $ &   $\{ (k-1/2) \,  \uppi \mid k \in \integers \} $     &  \begin{tikzpicture}[>=stealth]
   \begin{axis}[
       xmin=-4,xmax=4,
       ymin=-1.5,ymax=1.5,
       axis x line=middle,
...
%  \sin           & \reals        & [-1,1]  & \\
%  \tan           & \reals \setminus \{(k-1/2) \uppi \mod k \in \integers \} & \\
\end{tabular}
