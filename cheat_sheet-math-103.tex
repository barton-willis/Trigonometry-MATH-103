...
&\big [\cos(a) = b  \big] \equiv \big [a = \pm \cos^{-1}(b) + 2 k \uppi, k \in \integers \big ]\\
&\big [\sin(a) = b  \big] \equiv \big [a = \sin^{-1}(b) +  2 k \uppi,  \in \integers \mbox{ or } \\
&\quad \quad \quad \quad \quad \quad  a = -\sin^{-1}(b) + (2k + 1)\uppi,    k \in \integers \big ] \\        
