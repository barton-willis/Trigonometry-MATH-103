...
\mathrm{theta}  & \theta  \mbox{ or } \vartheta 
&\mbox{ angle}\\ 
...
\hline 
x & \cos(x) &  \sin(x) & \tan(x) \\ \hline 
0 & 1 & 0 & 0\\
\nicefrac{\ensuremath{\uppi} }{6} & \nicefrac{\sqrt{3}}{2} & \nicefrac{1}{2} & \nicefrac{1}{\sqrt{3}}\\
\nicefrac{\ensuremath{\uppi} }{4} & \nicefrac{1}{\sqrt{2}} & \nicefrac{1}{\sqrt{2}} & 1 \\
\nicefrac{\ensuremath{\uppi} }{3} & \nicefrac{1}{2} & \nicefrac{\sqrt{3}}{2} & \sqrt{3}\\
\nicefrac{\ensuremath{\uppi} }{2} & 0 & 1 & \mathrm{dne}\\
\nicefrac{2 \ensuremath{\uppi} }{3} & -\nicefrac{1}{2} & \nicefrac{\sqrt{3}}{2} & -\sqrt{3}\\
\nicefrac{3 \ensuremath{\uppi} }{4} & -\nicefrac{1}{\sqrt{2}} & \nicefrac{1}{\sqrt{2}} & -1 \\
\nicefrac{5 \ensuremath{\uppi} }{6} & -\nicefrac{\sqrt{3}}{2} & \nicefrac{1}{2} & -\nicefrac{1}{\sqrt{3}}\\
\ensuremath{\uppi}  & -1 & 0 & 0\\
\nicefrac{7 \ensuremath{\uppi} }{6} & -\nicefrac{\sqrt{3}}{2} & -\nicefrac{1}{2} & \nicefrac{1}{\sqrt{3}}\\
\nicefrac{5 \ensuremath{\uppi} }{4} & -\nicefrac{1}{\sqrt{2}} & -\nicefrac{1}{\sqrt{2}} & 1 \\
\nicefrac{4 \ensuremath{\uppi} }{3} & -\nicefrac{1}{2} & -\nicefrac{\sqrt{3}}{2} & \sqrt{3}\\
\nicefrac{3 \ensuremath{\uppi} }{2} & 0 & -1 & \mathrm{dne}\\
\nicefrac{5 \ensuremath{\uppi} }{3} & \nicefrac{1}{2} & -\nicefrac{\sqrt{3}}{2} & -\sqrt{3}\\
\nicefrac{7 \ensuremath{\uppi} }{4} & \nicefrac{1}{\sqrt{2}} & -\nicefrac{1}{\sqrt{2}} & -1\\
\nicefrac{11 \ensuremath{\uppi} }{6} & \nicefrac{\sqrt{3}}{2} & -\nicefrac{1}{2} & -\nicefrac{1}{\sqrt{3}}  \\ \hline 
\end{tabular}
...
\begin{tabular}{|L |  L L |}
\hline
x  & \arctan(x)  & \mathrm{arccot}(x) \\ \hline
-\sqrt{3} & -\nicefrac{\uppi}{3} & -\nicefrac{\uppi}{6}\\
-1        & -\nicefrac{\uppi}{4} & -\nicefrac{\uppi}{4}\\
-\nicefrac{1}{\sqrt{3}} & -\nicefrac{\uppi}{6} & -\nicefrac{\uppi}{3}\\
0 & 0 & \nicefrac{\uppi}{2}\\
...
\nicefrac{1}{g(x)}  & -g'(x) / g(x)^2 \\
\nicefrac{f(x)}{g(x)}   & \nicefrac{(g(x) f'(x) - f(x) g'(x))}{ g(x)^2} \\
f(g(x)) & g'(x) f'(g(x)) \\ 
...
\vspace{0.25in}
\tiny
\noindent Revised 10 Decemember 2021. Barton Willis is the author of this work. It 
licensed under Attribution 4.0 International (CC BY 4.0) \,  \qrcode[height=0.12in]{https://creativecommons.org/licenses/by/4.0/}. For the current version of
this document, visit \, \qrcode[height=0.12in]{https://github.com/barton-willis/Math-100-200-level} 
\end{multicols*}
\tiny  
