...
&\int x^a  \, \mathrm{d} x  = \frac{1}{1+a} x^a,  \quad \mbox{ if } a \neq -1 \\
...
\vfill
\tiny
\noindent This work is licensed under CC0 1.0. To view a copy of this license, visit \url{https://creativecommons.org/publicdomain/zero/1.0 }
